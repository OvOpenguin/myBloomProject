...
const Nav = () => {
    ...
    const toggleSubMenu = (menuName) => {
        if (openSubMenu === menuName) {
            setOpenSubMenu(null); // 如果已經打開，則收合
        } else {
            setOpenSubMenu(menuName); // 打開新的子選單
        }
    };
            ...
            <nav>
                <ul className='menu'>
                    ...
                    <li className='nav-blue'>
                        <NavLink to="/map" className={({ isActive }) => isActive ? "nav-blue active" : ""}><span className='nav-blue t'>花</span>卉地圖
                    ...
                    <li className='nav-pink'>
                        <NavLink to="/news" className={({ isActive }) => isActive ? "nav-pink active" : ""}><span className='nav-pink t'>賞</span>花快訊
