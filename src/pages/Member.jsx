        ...
        <div className="sidebar-item">
            <button type="button" onClick={onClick}>
                ...
                <div className="arrow-box">
                    ...
                    <svg className="arrow"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="11" viewBox="0 0 24 11" fill="none">
                        <path d="M1.55664 9.61914H22.1281L14.1087 1.61914" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                    </svg>
